...
public class UserController {
    ...
    public ResponseEntity<?> newUserModel(@RequestBody UserModel newUserModel) {
        ...
        // Ensure profile picture is generated if not provided
        if (newUserModel.getProfilePicture() == null || newUserModel.getProfilePicture().isEmpty()) {
            newUserModel.setProfilePicture(newUserModel.getProfilePicture()); // This will trigger the default generation
        }
    ...
    public List<String> getUserSkills(@PathVariable String id) {
        throw new UnsupportedOperationException("Skill functionality removed");
    }
